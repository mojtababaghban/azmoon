...
\end{document}
```
در حال حاظر سه قالب tabling و classic و fantasy برای این کلاس طراحی شده است که برای تغییر قالب باید هنگام فراخوانی کلاس مقدار template را برابر قالب دلخواه خود قرار دهید.
